 ...
 */
@Component
public class FirmwareVersionCommand extends HttpCommand<FirmwareVersionCommand.FirmwareVersionCommandContext, FirmwareVersionResultDto> {
    ...
    public FirmwareVersionCommand(HttpClient httpClient, ObjectMapper objectMapper) {
